  ...
  while (continuar) {
    ...
    switch (opcion) {
      ...
      case 1: {
        ...
        if (!prestado) {console.log("❌ Has alcanzado el límite de préstamos");
          break;}
      ...
      case 2: {
        ...
        if (!libro) {console.log("❌ Libro no encontrado");
          break;
        }
...
private menuInventario(usuario: IInventario): void {
  ...
  while (continuar) {
    ...
    switch (opcion) {
      ...
      case 1: {const id = Number(prompt("👉 ID del libro: "));

        if (this.catalogo.some(l => l.id === id)) {console.log("❌ Ya existe un libro con ese ID");
          break;
        }
      ...
      case 2: {
        ...
        if (index === -1) {console.log("❌ Libro no encontrado");
          break;
        }
